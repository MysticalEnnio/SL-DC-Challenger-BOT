    ...
    execute: async (data, interaction, client) => {
        ...
        if (interaction.user.id == proposerId) {
            return interaction.followUp({
                content: "You can't decline your own time suggestion!",
            });
        }
        ...
        currentClient.close();
        proposer.send({
            content: `${interaction.user.username} has declined the proposed time for your challenge!`,
        });
        interaction.followUp({
            content: `${interaction.user.username} has declined proposed time for the challange!`,
        });
    },
};
